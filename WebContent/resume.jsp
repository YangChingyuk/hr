...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#dg").datagrid({
			...
			columns:[[
				{field:"",checkbox:true},
				{field:"id",title:"履历编号",width:100,align:"center"},
				{field:"empname",title:"员工编号",width:100,align:"center"},
				...
				{field:"content",title:"工作内容",width:100,align:"center"},
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "resupdate?id="+array[0].id;
      	
		$.ajax({
      		url:"resqueryById?id="+array[0].id,
      		type:"post",
      		dataType:"json",
      		success:function(result){
      		//表单填充内容
