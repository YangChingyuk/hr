...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#dg").datagrid({
			...
			columns:[[
				{field:"",checkbox:true},
				{field:"id",title:"奖励编号",width:100,align:"center"},
				...
				{field:"type",title:"奖金类别",width:100,align:"center"},
				{field:"creatDate",title:"奖惩时间",width:100,align:"center"}
			]],
			fitColumns:true,
			toolbar: [{
				text:"新增",
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "reupdate?id="+array[0].id;
      	
		$.ajax({
      		url:"requeryById?id="+array[0].id,
      		type:"post",
      		dataType:"json",
      		success:function(result){
      		//表单填充内容
	...
	<div id="dd" class="easyui-dialog" style="width: 400px;text-align: center;padding: 10px;" closed="true">
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					<td class="right">奖金类别：</td>
					<td><input type="text" name="type" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">奖惩时间：</td>
					<td><input type="text" name="creatDate" class="easyui-datebox" data-options="required:true"></td>
				</tr>
			</table>
		</form>
	</div>
