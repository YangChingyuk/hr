...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#dg").datagrid({
			...
			columns:[[
				{field:"",checkbox:true},
				{field:"id",title:"合同id",width:100,align:"center"},
				...
				{field:"attachment",title:"附件文档",width:100,align:"center"}
			]],
			fitColumns:true,
			toolbar: [{
				text:"新增",
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "cotupdate?id="+array[0].id;
      	
		$.ajax({
      		url:"cotqueryById?id="+array[0].id,
      		type:"post",
      		dataType:"json",
      		success:function(result){
      		//表单填充内容
